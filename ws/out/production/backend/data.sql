INSERT INTO User (id, firstname, lastname, username, password, salary, age, role) VALUES (1, 'Alex','Knr', 'alex123','$2a$04$4vwa/ugGbBVDvbWaKUVZBuJbjyQyj6tqntjSmG8q.hi97.xSdhj/2', 3456, 33, 'ROLE_ADMIN');
INSERT INTO User (id, firstname, lastname, username, password, salary, age, role)  VALUES (2, 'Tom', 'Asr', 'tom234', '$2a$04$QED4arFwM1AtQWkR3JkQx.hXxeAk/G45NiRd3Q4ElgZdzGYCYKZOW', 7823, 23, 'ROLE_USER');
INSERT INTO User (id, firstname, lastname, username, password, salary, age, role)  VALUES (3, 'Adam', 'Psr', 'adam', '$2a$04$WeT1SvJaGjmvQj34QG8VgO9qdXecKOYKEDZtCPeeIBSTxxEhazNla', 4234, 45, 'ROLE_USER');
